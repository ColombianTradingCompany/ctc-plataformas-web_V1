...
| owner | consolas | Validar la escala de puntos (multiplicativa: base CCC × M, K = (2500/1990 − 1)/6; puerta de entrada 80–81,99; Tyrian exige SCA ≥ 89) con la calculadora del artefacto «PVC · Cinco decisiones» —pesos iguales de V·P·R, puerta de Tyrian, caso AAA:80— y fijar el **X %** del collar de TRM (propuesta 6 %) antes de que la fase 2 toque `definicion.ts` (`PVC_BCP_PLAN.md` §9.1) | 2026-09-15 |
