...
| owner | consolas, cherry-picked, kaffetal-regal, herramientas-cafe | Preguntas abiertas del CEO (`PVC_BCP_PLAN.md` §12.11): tarifa de conexión de CTC (fija o %), beneficios y pesos de la reputación, Plus contra Básica, y **alinear PVC-F4-2026 a trimestre exacto** (hoy 15-sep → 15-dic) | 2026-09-16 |
