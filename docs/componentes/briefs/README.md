...
| [`consolas-gestion-de-muestras.md`](consolas-gestion-de-muestras.md) | consolas | OCP · Gestión de Muestras — **1.ª tanda EJECUTADA en la V5.80** (fase 3 del `PLAN_CIRCUITO_DEL_LOTE`): las dos tablas, el recibo con la partición del folio 7, el saldo derivado, salidas y pedidos de muestra; **2.ª tanda EJECUTADA en la V5.88** (la revisión de almacenaje a los 90 días como tarea derivada; los pedidos de pack armados y enviados con rastro); quedan del owner las decisiones 1, 4 y 5 | nada |
