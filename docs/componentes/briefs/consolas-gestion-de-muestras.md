...
> automática) — **confirmado por el owner el 2026-09-25** (también que la columna «laboratorio» no vuelve); la 1 (ubicaciones y custodio) sigue en texto libre; la 4 y la 5 (muestra de UN lote desde la tienda; composición del pack de
