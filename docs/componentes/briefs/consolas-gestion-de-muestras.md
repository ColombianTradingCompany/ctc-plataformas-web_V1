...
> automática) — **confirmado por el owner el 2026-09-25** (también que la columna «laboratorio» no vuelve); la 1 → **opción C ejecutada en la V5.89** (tabla `bodegas_muestras`: responsable, dirección, capacidad en muestras de 1 kg, estado; cuatro sedes del owner; ocupación derivada; arranque del módulo de administración de bodega); la 2 la precisó el owner el 2026-09-25 (los 2 kg son de uso EXCLUSIVO de CTCx: 2 × 250 g Q-Grader · 2 × 250 g reserva CPS · el kilo CTCx trillado a ~750 g de verde = 400 g tostado de ensayo + 250 g verde al vacío; diagrama en `reference/muestras-y-sample-kits-2026-09-25/`); la 4 y la 5 quedaron contestadas el 2026-09-25: las muestras para compradores son los **Sample Kits** (CP · Plus · Max) y se surten desde **Adquisición de Stock Café (Selection/Sample Kits)** con su módulo de Sample Kits en OCP · Catálogo (V5.90), no de los 2 kg del productor.** No hay un solo dato que migrar: cero muestras enviadas, cero recibidas.
