...
- Los bloques **1 y 2 se fundieron**: «en cada paso le mostramos lo que recibe y lo que se le pide» pasa a pantalla.
- **Bloque 8**: la contra-catación y el crédito a favor pasan a pantalla.
- **Bloque 10**: la revisión de almacenaje a más de 90 días pasa a pantalla.
- **Bloque 11**: la segunda oración (reputación) pasa a pantalla.
- **Bloque 9**: era el más largo con 172 palabras; se apretó sin soltar prima, compra inicial, escalera, 4 % ni CTCx Selection.
- Prosa más apretada en los bloques 3, 4, 5, 6, 7 y 12, sin quitar hechos.
