// ⚠️ V5.60: la Arena vive en «BCP · Ecosistema de Valor», pero esta página sigue usando TRES piezas del circuito
// del lote, que es del OCP: asignar un lote a una sesión, invitarlo a la vitrina y revisar un reclamo. Se importan por
// ruta absoluta —no se duplican— y sus tres acciones abren las DOS consolas (`["ocp", "bcp"]`). La fase 4 del overhaul
// rehace ese circuito; si entonces la Arena deja de asignar lotes, estos dos imports desaparecen.
import Link from "next/link";
import { createServiceRoleClient } from "@/lib/supabase/server";
import { fetchProducerContacts } from "@/lib/bcpProducers";
import { createArenaSession } from "../arenaActions";
import { ActionForm } from "@/components/panel/ActionForm";
import { reviewEvaluationClaim } from "@/app/ocp/(app)/evaluationActions";
...
import { AssignSessionControls, InviteToShowcaseButton } from "@/app/ocp/(app)/nominados/NominadosClient";
