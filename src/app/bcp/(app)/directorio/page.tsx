...
// BCP · Ecosistema de Valor · Directorio del Café (del ECP hasta la V5.59) — verificación de fichas + moderación del muro.
// Gated by the (app) layout's requireConsoleAccess("bcp"); every action
