...
// ── BCP · Herramientas del café · el registro escribible ─────────────────────
 ...
 *  montan un panel de herramientas más el propio tablero de la consola (BCP desde la V5.60). */
const RUTAS = ["/bcp/herramientas", "/kaffetal-regal", "/cherry-picked-green", "/herramientas", "/directorio"];
