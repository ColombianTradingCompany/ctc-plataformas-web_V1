...
// ── Talón de la mudanza: `/bcp/arena` se fue al OCP ──
...
// con UN archivo: `/bcp/arena`, `/bcp/arena/algo` y `/bcp/arena/algo/mas`.
...
export default async function TalonBcpArena({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/arena" + cola) ?? "/ocp");
}
