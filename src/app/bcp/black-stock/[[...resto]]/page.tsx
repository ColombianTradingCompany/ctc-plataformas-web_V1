...
// ── Talón de la mudanza: `/bcp/black-stock` se fue al OCP ──
...
// con UN archivo: `/bcp/black-stock`, `/bcp/black-stock/algo` y `/bcp/black-stock/algo/mas`.
...
export default async function TalonBcpBlackStock({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/black-stock" + cola) ?? "/ocp");
}
