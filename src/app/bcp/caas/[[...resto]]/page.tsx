...
// ── Talón de la mudanza: `/bcp/caas` se fue al OCP ──
...
// con UN archivo: `/bcp/caas`, `/bcp/caas/algo` y `/bcp/caas/algo/mas`.
...
export default async function TalonBcpCaas({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/caas" + cola) ?? "/ocp");
}
