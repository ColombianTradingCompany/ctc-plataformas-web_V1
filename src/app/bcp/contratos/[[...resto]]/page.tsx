...
// ── Talón de la mudanza: `/bcp/contratos` se fue al OCP ──
...
// con UN archivo: `/bcp/contratos`, `/bcp/contratos/algo` y `/bcp/contratos/algo/mas`.
...
export default async function TalonBcpContratos({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/contratos" + cola) ?? "/ocp");
}
