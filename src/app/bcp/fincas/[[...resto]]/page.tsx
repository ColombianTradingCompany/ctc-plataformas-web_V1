...
// ── Talón de la mudanza: `/bcp/fincas` se fue al OCP ──
...
// con UN archivo: `/bcp/fincas`, `/bcp/fincas/algo` y `/bcp/fincas/algo/mas`.
...
export default async function TalonBcpFincas({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/fincas" + cola) ?? "/ocp");
}
