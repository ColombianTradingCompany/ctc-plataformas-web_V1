...
// ── Talón de la mudanza: `/bcp/galardonados` se fue al OCP ──
...
// con UN archivo: `/bcp/galardonados`, `/bcp/galardonados/algo` y `/bcp/galardonados/algo/mas`.
...
export default async function TalonBcpGalardonados({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/galardonados" + cola) ?? "/ocp");
}
