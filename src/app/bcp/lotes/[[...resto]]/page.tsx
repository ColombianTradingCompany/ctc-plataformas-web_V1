...
// ── Talón de la mudanza: `/bcp/lotes` se fue al OCP ──
...
// con UN archivo: `/bcp/lotes`, `/bcp/lotes/algo` y `/bcp/lotes/algo/mas`.
...
export default async function TalonBcpLotes({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/lotes" + cola) ?? "/ocp");
}
