...
// ── Talón de la mudanza: `/bcp/nominados` se fue al OCP ──
...
// con UN archivo: `/bcp/nominados`, `/bcp/nominados/algo` y `/bcp/nominados/algo/mas`.
...
export default async function TalonBcpNominados({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/nominados" + cola) ?? "/ocp");
}
