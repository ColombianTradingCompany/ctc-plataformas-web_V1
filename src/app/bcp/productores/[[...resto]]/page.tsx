...
// ── Talón de la mudanza: `/bcp/productores` se fue al OCP ──
...
// con UN archivo: `/bcp/productores`, `/bcp/productores/algo` y `/bcp/productores/algo/mas`.
...
export default async function TalonBcpProductores({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/productores" + cola) ?? "/ocp");
}
