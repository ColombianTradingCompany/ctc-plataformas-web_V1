...
// ── Talón de la mudanza: `/bcp/subastas` se fue al OCP ──
...
// con UN archivo: `/bcp/subastas`, `/bcp/subastas/algo` y `/bcp/subastas/algo/mas`.
...
export default async function TalonBcpSubastas({
  params,
}: {
  ...
  permanentRedirect(destinoDe("/bcp/subastas" + cola) ?? "/ocp");
}
