...
export const generateMetadata = superficieConOverrides({
  ...
  description:
    "Coming 2027: every Cherry Picked Green lot, roasted in Europe by the CTC Master Roaster — Green price + 9.50 US$/kg fulfillment, your label or ours, same lot passport. Follow the build-up — Colombian Trading Company",
