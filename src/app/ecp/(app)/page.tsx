...
export default function EcpHomePage() {
  ...
  return (
    <ConsoleScaffold
      ...
      modules={[
        { name: "Documentación del sistema", desc: "El mapa vivo de la plataforma, versión a versión: nodos, escenarios de negocio, esquema y mapa de archivos — más los informes de auditoría.", built: true, href: "/bcp/documentacion" },
