...
// ogg_transcriber (`tools/transcriptor/`: faster-whisper + pyannote, corre en
// el equipo con GPU; el ZIP de `/api/transcripciones/descargar` sale de ahí). La plataforma no transcribe:
