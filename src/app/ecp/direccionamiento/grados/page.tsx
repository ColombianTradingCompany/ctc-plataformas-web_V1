...
// ── Talón de la mudanza: `/ecp/direccionamiento/grados` ──
...
export default function TalonEcpDireccionamientoGrados() {
  permanentRedirect(destinoDe("/ecp/direccionamiento/grados") ?? "/bcp");
}
