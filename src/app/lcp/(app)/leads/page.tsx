...
// el BCP (V5.60). El reparto tiene fuente única: `src/lib/panel/leadsPilares.ts`.
...
export default function LcpLeadsPage() {
  return (
    <LeadsBoard
      ...
      subtitle='Las consultas generales de "Escríbenos" llegan aquí con su cuenta de plataforma creada. Los de CaaS están en su CRM, aquí en la LCP; los de CTC Tech y Varietales, en el tablero de su superficie (BCP).'
    />
  );
}
