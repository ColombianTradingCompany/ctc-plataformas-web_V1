...
type InsRow = { lot_id: string; producer_id: string; phase: string; status: string; sondeo_batch_id: string | null; sondeo_result: string | null; decision_comercial: string | null };
