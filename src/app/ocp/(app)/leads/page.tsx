...
export default function OcpLeadsPage() {
  return (
    <LeadsBoard
      ...
      subtitle='Las consultas generales de "Escríbenos" llegan aquí con su cuenta de plataforma creada. Los leads de CTC Tech, CaaS y Varietales viven en el CRM de su consola dueña (ECP y BCP).'
    />
  );
}
