...
import { CUR } from "@/components/cherry-picked/data";
...
const EN = {
  ...
  fGreen: "Green price",
  fGreenV: `${CUR}/kg catalog`,
  fFee: "Roast & fulfillment",
  fFeeV: `9.50 ${CUR}/kg`,
  fHon: "Orchestration honoraries",
  fHonV: "by grade",
  fTotal: "Your roasted price",
  fTotalV: `${CUR}/kg, in full`,
  pricingP: `Roast pricing roots in the live Green catalog: the lot's Green price per kilo plus a flat 9.50 ${CUR}/kg fulfillment fee covering roasting, packing and handling. No hidden margins — when a Green price moves with the harvest, your Roast price moves with it, and the base price is always there in the catalog for you to check.`,
