...
const EN = {
  ...
  imgAlt: "A roastery café bar in Europe",
};
...
const T: Record<Lang, typeof EN> = {
  ...
  es: {
    ...
    imgAlt: "La barra de una tostaduría en Europa",
  },
  de: {
    ...
    imgAlt: "Die Bar einer Rösterei in Europa",
  },
};
    ...
    <section id="black">
      <div className="wrap">
        ...
        <div className={styles.blackIntro}>
          ...
          <Image src="/images/cherry-picked/31-bar-tostaduria.jpg" alt={t.imgAlt} width={351} height={264} />
        </div>
