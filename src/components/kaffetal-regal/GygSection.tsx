...
const T: Record<Lang, Dict> = {
  es: {
    ...
    q2: "”",
    p1: "Somos padre e hijo: dos ingenieros mecánicos especialistas en procesos industriales y operaciones, caficultores con finca propia, y fundadores de Colombian Trading Company. Conocemos las dos puntas de este negocio: sabemos lo que cuesta una cosecha bien hecha porque la hacemos con nuestras manos, y sabemos lo que un tostador europeo está dispuesto a pagar por ella porque se la vendemos de frente. El trecho entre la vereda y la tostadora —ese que durante décadas se quedó en manos sin rostro— es exactamente lo que Kaffetal Regal viene a acortar.",
  ...
  en: {
    ...
    q2: "”",
    p1: "We are father and son: two mechanical engineers specialised in industrial processes and operations, coffee growers with a farm of our own, and founders of Colombian Trading Company. We know both ends of this business: we know what a well-made harvest costs because we make it with our own hands, and we know what a European roaster is willing to pay for it because we sell it to them face to face. The stretch between the vereda and the roaster — the one that for decades stayed in faceless hands — is exactly what Kaffetal Regal comes to shorten.",
