...
const T: Record<Lang, Dict> = {
  es: {
    sections: [
      ...
      { id: "arena", n: "04", label: "La Arena", sub: "La vitrina en vivo de los mejores" },
  ...
  en: {
    sections: [
      ...
      { id: "arena", n: "04", label: "The Arena", sub: "The live showcase of the best" },
  ...
  de: {
    sections: [
      ...
      { id: "arena", n: "04", label: "Die Arena", sub: "Die Live-Bühne der Besten" },
