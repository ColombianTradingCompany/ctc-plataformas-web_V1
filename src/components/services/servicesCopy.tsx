// ── La copy trilingüe de los servicios de la red (V4 · Fase 2) ───────────────
// Vivía dentro de ServicesSection (CTC Home); con la Fase 2 la fuente única se
// mudó AQUÍ y quien la consume son las superficies independientes (CtcTechLanding,
// CoCreateLanding, VarietalesLanding) y la ficha de ruta de CTC Home. Si un
// texto de servicio cambia, se cambia en este archivo y en ningún otro lugar.
...
export type { TechCopy, Dict as ServicesDict, TechImage };
